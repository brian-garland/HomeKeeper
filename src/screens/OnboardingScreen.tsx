...
const HomeCharacteristicsStep: React.FC<{ onNext: (characteristics: any) => void }> = ({ onNext }) => {
  ...
  const homeTypes = [
    ...
    { id: 'condo', label: 'Condominium', icon: 'business' },
          ...
          <View style={styles.homeTypeGrid}>
            {homeTypes.map((type) => (
              <Button
                ...
                variant={homeType === type.id ? 'primary' : 'secondary'}
...
const PersonalizationStep: React.FC<{ onNext: (preferences: any) => void }> = ({ onNext }) => {
  ...
  const maintenanceStyles = [
    { id: 'proactive', label: 'Proactive', description: 'Stay ahead of issues', icon: 'shield-checkmark' },
    { id: 'balanced', label: 'Balanced', description: 'Mix of prevention & fixes', icon: 'scale' },
    { id: 'reactive', label: 'As-Needed', description: 'Fix things when they break', icon: 'construct' },
  ];

  const timeOptions = [
    { id: 'weekends', label: 'Weekends Only', icon: 'calendar' },
    { id: 'evenings', label: 'Weekday Evenings', icon: 'moon' },
    { id: 'flexible', label: 'Flexible Schedule', icon: 'time' },
  ];

  const notificationOptions = [
    { id: 'gentle', label: 'Gentle Reminders', icon: 'notifications' },
    { id: 'standard', label: 'Standard Notifications', icon: 'notifications' },
    { id: 'minimal', label: 'Minimal Notifications', icon: 'notifications-off' },
  ];
        ...
        <View style={styles.formSection}>
          ...
          {maintenanceStyles.map((style) => (
            <Button
              ...
              variant={maintenanceStyle === style.id ? 'primary' : 'secondary'}
        ...
        <View style={styles.formSection}>
          ...
          {timeOptions.map((option) => (
            <Button
              ...
              variant={availableTime === option.id ? 'primary' : 'secondary'}
              style={styles.preferenceButton}
              icon={option.icon}
            />
          ))}
        ...
        <View style={styles.formSection}>
          ...
          {notificationOptions.map((option) => (
            <Button
              ...
              variant={notifications === option.id ? 'primary' : 'secondary'}
              style={styles.preferenceButton}
              icon={option.icon}
            />
          ))}
      ...
      <View style={styles.stepContainer}>
        <View style={styles.generatingContainer}>
          <View style={styles.loadingIcon}>
            <Icon name="construct" size="xl" color={Colors.primary} />
          </View>
      ...
      >
        ...
        <View style={styles.schedulePreview}>
          ...
          <View style={styles.taskPreview}>
            <Icon name="water" size="md" color={Colors.primary} />
          ...
          <View style={styles.taskPreview}>
            <Icon name="leaf" size="md" color={Colors.success} />
            <View style={styles.taskInfo}>
...
export const OnboardingScreen: React.FC<OnboardingScreenProps> = ({ onComplete }) => {
  ...
  const { } = useSupabase(); // createHome will be added later

  const steps: OnboardingStep[] = [
    { id: 'welcome', title: 'Welcome', subtitle: 'Get started with HomeKeeper', component: WelcomeStep },
    { id: 'address', title: 'Address', subtitle: 'Where is your home?', component: AddressStep },
    { id: 'characteristics', title: 'Home Details', subtitle: 'Tell us about your home', component: HomeCharacteristicsStep },
    { id: 'personalization', title: 'Preferences', subtitle: 'Personalize your experience', component: PersonalizationStep },
    { id: 'reveal', title: 'Ready!', subtitle: 'Your schedule is ready', component: CalendarRevealStep },
  ];
