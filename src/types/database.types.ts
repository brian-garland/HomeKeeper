    ...
    Tables: {
      ...
      homes: {
        Row: {
          ...
          high_maintenance_mode: boolean | null
          ...
          maintenance_season_start: number | null
          name: string
          notes: string | null
          owner_id: string
      ...
      maintenance: {
        Row: {
          ...
          recurring_frequency_months: number | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "maintenance_home_id_fkey"
            columns: ["home_id"]
            isOneToOne: false
            referencedRelation: "homes"
            referencedColumns: ["id"]
      ...
      task_templates: {
        Row: {
          active: boolean | null
          applies_to_equipment_types: string[] | null
          applies_to_home_types: string[] | null
          category: string
          climate_conditions: string[] | null
          consequences_if_skipped: string | null
          created_at: string | null
          description: string | null
      ...
      user_profiles: {
        Row: {
          ...
          share_completion_stats: boolean | null
          share_with_neighbors: boolean | null
